...
struct AnmManager
{
    ...
    ZunResult DrawVertices(AnmVm *vm, void *vertices, i32 vertexCount); /* 0x464c60 */
    ...
    ZunResult SetTextureCaptureParams(i32 a, i32 b, i32 c, i32 d, i32 e, i32 f, i32 g, i32 h, i32 i);
